...
export class Convert {
  public static toSeachResponse(json: string): SeachResponse {
      return cast(JSON.parse(json), r("SeachResponse"));
  }

  public static seachResponseToJson(value: SeachResponse): string {
      return JSON.stringify(uncast(value, r("SeachResponse")), null, 2);
  }
}
